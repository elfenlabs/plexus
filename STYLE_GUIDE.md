# Plexus C++ Style Guide

This document defines the coding conventions and style guidelines for the Plexus project. All contributions should adhere to these standards to maintain consistency.
...
2. Project headers (`"plexus/..."`, `"..."`)
3. Standard library headers (`<atomic>`, `<vector>`, etc.)

```cpp
#include "plexus/graph_builder.h"   // 1. Corresponding header

#include "plexus/context.h"          // 2. Project headers
...
```
include/plexus/    # Public headers (API)
...
- Public API headers go in `include/plexus/`
...
```cpp
namespace Plexus {                              // PascalCase namespace
