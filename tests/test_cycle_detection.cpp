...
TEST(CycleDetectionTest, SimpleCycle) {
    ...
    builder.add_node(
        {"Node1", []() {}, {{res_a, Cycles::Access::READ}, {res_b, Cycles::Access::WRITE}}});

    // Node 2: Reads B, Writes A
    builder.add_node(
        {"Node2", []() {}, {{res_b, Cycles::Access::READ}, {res_a, Cycles::Access::WRITE}}});
...
TEST(CycleDetectionTest, SelfCycle) {
    ...
    builder.add_node(
        {"Selfie", []() {}, {{res_a, Cycles::Access::READ}, {res_a, Cycles::Access::WRITE}}});
